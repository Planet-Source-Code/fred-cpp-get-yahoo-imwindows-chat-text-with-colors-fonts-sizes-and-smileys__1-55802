...
Public Const c_ChatStyle            As String = "<STYLE>" & vbCrLf & _
                                                ...
                                                "</STYLE>"
Public Const c_PMStyle              As String = "" & _
"<html>" & _
"<head>" & _
"<meta http-equiv=""Content-Type"" content=""text/html; charset=windows-1252"">" & _
"<title>Get Y!Text 6 by Fred.cpp</title>" & _
"<STYLE>" & _
".sendername { font-size:10pt;font-family:Arial;font-weight:bold;color:#000000; }" & _
".tablalarga  { width: 100%; border: 1px solid #888888; padding-left: 4; padding-right: 4;padding-top: 1; padding-bottom: 1; background-color: #F7F7F7; position:absolute; left:0; font-size:8pt }" & _
".status  { width: 100%; border: 1px solid #888888; padding-left: 4; padding-right: 4;padding-top: 1; padding-bottom: 1; background-color: #F7F7F7; position:relative; left:0; font-size:8pt }" & _
".recvername { font-size:10pt;font-family:Arial;font-weight:bold;color:#0000FF; }" & _
".ymsgrname { font-size:10pt;font-family:Arial;font-weight:bold;color:#FF0000; }" & _
".usertext { font-size:10pt;font-family:Arial; }" & _
".redstatus { font-size:10pt;font-family:Arial;font-weight:bold;color:#FF0000; }" & _
".greenstatus { font-size:10pt;font-family:Arial;font-weight:bold;color:#008800; }" & _
".graystatus { font-size:10pt;font-family:Arial;font-weight:bold;color:#888888; }" & _
".imvnotify { font-size:10pt;font-family:Arial;font-weight:bold;color:#000088; }" & _
"a { color:#0000FF; }" & _
"p { text-indent:-7;margin-left:10;margin-top:0;margin-bottom:0 }" & _
"h3           { font-size: 10pt; color: #808080 }" & _
"</STYLE>" & _
"</head>" & _
...
Public Function GetIMText() As YIMType
    ...
    For X = 0 To Something.Count
        ...
        Debug.Print "Window Class: " & sTmp
        If Len(sTmp) > 4 Then
            If StrComp(sTmp, "YHTMLContainer", vbTextCompare) = 0 Then
