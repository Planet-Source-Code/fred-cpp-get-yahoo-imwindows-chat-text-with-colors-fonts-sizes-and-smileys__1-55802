...
' Later, Improved By me again.
' Based on Get YM! Chat Text & HTML from
' "Internet Explorer_Server" object By: James Johnston
'
...
Sub AddAbout()
    ...
    "<html>" & _
    "<head>" & _
    "<title>About GetY!Text</title>" & _
    "<base target=""_blank"">" & _
    "</head>" & _
    "<body text=""BUTTONTEXT"" bgcolor=""BUTTONFACE"" vlink=""#000080"" alink=""#0066FF"">" & _
    "<p align=""center""><font face=""Verdana"" size=""4"">Get</font><font face=""Verdana"" size=""4"">Yahoo! Text</font></p>" & _
    "<p align=""center""><font size=""2"" face=""Verdana"">Get The Yahoo IM Windows text with full colors/fonts and Smileys!</font></p>" & _
    "<p align=""center""><b><font face=""Verdana""><font size=""2"">By </font><a href=""http://mx.geocities.com/fred_cpp""><font size=""2"">Fred.cpp</font></a></font></b></p>" & _
    "</body>" & _
    "</html>"
    Open App.Path & "\tmp.htm" For Output As #1
    Print #1, tmpStr
